...
\033[1;98m    ║✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ☪ MADE BY NABIL VAU🔥            ║  
...
jalan("\033[1;97m    ██████ 50%  ")
jalan("\033[1;97m    ██████ 99%  ")
jalan("\033[1;97m    ██████ Nabil VaU Is ReadY  ")
print "\033[1;91m«-------------\033[1;93mLogin With NABIL VAU Tool\033[1;91m-------------»"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged As NABIL VAU " + username #Dev:love_hacker
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mNABIL VAU BOLTASE APNAR ACC CHEKPOINT😂")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;96m[!] \x1b[1;91mMADARFUKA VUL PASSWORD😂")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	print "\033[1;36;40m      ╚═════════════════════════════════╝"
	print "    \033[1;32;40m[Type1] \033[1;33;40m‹•.•›Start NABIL VAU "	
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mNABIL VAU\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mNABIL VAU\033[1;95m•◈•══════••◈•"
		try:
	...
	print "\n\033[1;94m        ❈     \x1b[1;91mNABIL VAU SAYS USE VPN \033[1;94m    ❈"
	print "   \033[1;92m●══════════════════◄►══════════════════●"

	jalan('           \033[1;91mNABIL vau start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mNABIL VAU\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By NABIL RAHMAN--•◈•---»" #Dev:Rana
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (nabil.vau.py)↩\033[1;97m....'
